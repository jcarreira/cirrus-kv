...
#define SOFTMAX_BASE  (20 * BILLION)
#define SAMPLE_BASE   (SOFTMAX_BASE + 0)
#define MODEL_BASE    (SOFTMAX_BASE + 1 * BILLION)
#define GRADIENT_BASE (SOFTMAX_BASE + 2 * BILLION)
#define LABEL_BASE    (SOFTMAX_BASE + 3 * BILLION)
#define START_BASE    (SOFTMAX_BASE + 4 * BILLION)
int nworkers = 1;
