...
struct WriteBuilder {
  ...
  void add_oid(uint64_t oid) {
    fbb_.AddElement<uint64_t>(Write::VT_OID, oid, 0);
  }
...
struct WriteAck FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int8_t success() const {
    return GetField<int8_t>(VT_SUCCESS, 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint64_t>(verifier, VT_OID) &&
           VerifyField<int8_t>(verifier, VT_SUCCESS) &&
           verifier.EndTable();
  }
};
...
struct WriteAckBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_oid(uint64_t oid) {
    fbb_.AddElement<uint64_t>(WriteAck::VT_OID, oid, 0);
  }
  void add_success(int8_t success) {
    fbb_.AddElement<int8_t>(WriteAck::VT_SUCCESS, success, 0);
  }
...
struct ReadBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_oid(uint64_t oid) {
    fbb_.AddElement<uint64_t>(Read::VT_OID, oid, 0);
  }
...
struct ReadAckBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_oid(uint64_t oid) {
    fbb_.AddElement<uint64_t>(ReadAck::VT_OID, oid, 0);
  }
  void add_success(int8_t success) {
    fbb_.AddElement<int8_t>(ReadAck::VT_SUCCESS, success, 0);
  }
  void add_data(flatbuffers::Offset<flatbuffers::Vector<int8_t>> data) {
...
struct RemoveBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_oid(uint64_t oid) {
    fbb_.AddElement<uint64_t>(Remove::VT_OID, oid, 0);
  }
...
struct RemoveAckBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_oid(uint64_t oid) {
    fbb_.AddElement<uint64_t>(RemoveAck::VT_OID, oid, 0);
  }
  void add_success(int8_t success) {
    fbb_.AddElement<int8_t>(RemoveAck::VT_SUCCESS, success, 0);
  }
...
struct TCPBladeMessage FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  uint64_t txnid() const {
    return GetField<uint64_t>(VT_TXNID, 0);
  }
  int64_t error_code() const {
    return GetField<int64_t>(VT_ERROR_CODE, 0);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint64_t>(verifier, VT_TXNID) &&
           VerifyField<int64_t>(verifier, VT_ERROR_CODE) &&
...
struct TCPBladeMessageBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_txnid(uint64_t txnid) {
    fbb_.AddElement<uint64_t>(TCPBladeMessage::VT_TXNID, txnid, 0);
  }
  void add_error_code(int64_t error_code) {
    fbb_.AddElement<int64_t>(TCPBladeMessage::VT_ERROR_CODE, error_code, 0);
  }
  ...
  flatbuffers::Offset<TCPBladeMessage> Finish() {
    ...
    fbb_.Required(o, TCPBladeMessage::VT_MESSAGE);
    return o;
  }
};
