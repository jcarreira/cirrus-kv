...
#ifndef FLATBUFFERS_GENERATED_BLADEMESSAGE_MESSAGE_BLADEMESSAGE_H_
#define FLATBUFFERS_GENERATED_BLADEMESSAGE_MESSAGE_BLADEMESSAGE_H_
...
inline const Message::BladeMessage::BladeMessage *GetBladeMessage(const void *buf) {
  return flatbuffers::GetRoot<Message::BladeMessage::BladeMessage>(buf);
}

inline bool VerifyBladeMessageBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Message::BladeMessage::BladeMessage>(nullptr);
}

inline void FinishBladeMessageBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<Message::BladeMessage::BladeMessage> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_BLADEMESSAGE_MESSAGE_BLADEMESSAGE_H_
