...
void test_allocation() {
    ...
    cirrus::FileAllocRec alloc1 = client.allocate("/tmp/test", 1 * MB);

    cirrus::LOG<cirrus::INFO>("Received allocation 1",
    ...
    cirrus::FileAllocRec alloc2 = client.allocate("/tmp/test", 2 * MB);
    cirrus::LOG<cirrus::INFO>("Received allocation 2.",
    ...
    client.read_sync(alloc1, 0, strlen(to_send), data);
    cirrus::LOG<cirrus::INFO>("Received data 3: ", data);
}
